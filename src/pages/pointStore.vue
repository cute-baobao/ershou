    ...
    >
        ...
        <div class="container mx-auto px-4 py-8 relative z-10">
            <header class="text-center mb-12">
                <h1
                    class="text-5xl font-bold mb-4 text-blue-600 dark:text-green-300 drop-shadow-lg"
                >
                    绿色积分商城
                </h1>
                <p
                    class="text-xl text-blue-600 dark:text-green-200 max-w-2xl mx-auto drop-shadow"
                >
            ...
            >
                ...
                <div class="relative z-10">
                    <h2
                        class="text-2xl font-semibold mb-4 text-green-700 dark:text-green-300"
                    >
                        您的碳积分
                    </h2>
                    <div class="flex items-center justify-between">
                        <span
                            v-if="userPoints !== -1"
                            class="text-5xl font-bold text-green-600 dark:text-green-400"
                            >{{ userPoints }}</span
                        >
                        <span
                            v-else
            ...
            >
                <Card
                    v-for="(product, index) in pointProduct.records"
                    :key="product.id"
                ...
                >
                    ...
                    <CardContent>
                        <TooltipProvider>
                            <Tooltip :delayDuration="300">
                                <TooltipTrigger asChild>
                                    <p
                                        class="text-xl font-semibold text-green-700 dark:text-green-300 line-clamp-1"
                                    >
                                        {{ product.title }}
                                    </p>
                                </TooltipTrigger>
                        ...
                        <div class="flex justify-between items-center">
                            <span
                                class="text-2xl font-bold text-orange-500 dark:text-green-400"
                                >{{ product.pointsPrice }} 积分</span
                            >
                            <Button
            ...
            >
                ...
                <div class="relative z-10">
                    <h2
                        class="text-3xl font-bold mb-10 text-white dark:text-green-200"
                    >
                        我们的环保宣言
                    </h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="flex flex-col items-center">
                            ...
                            >
                                <svg
                                    class="w-12 h-12 text-emerald-600 dark:text-green-200"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <h3
                                class="text-xl font-semibold mb-2 text-white dark:text-green-200"
                            >
                                减少碳足迹
                            </h3>
                            <p class="text-green-100 dark:text-green-300">
                                每一个小行动都能为地球减少碳排放，让我们共同努力。
                            </p>
                        </div>
                        <div class="flex flex-col items-center">
                            <div
...
const getPointProduct = () => {
    ...
    api({
        ...
        .then((res) => {
            ...
            pointProduct.value.records.forEach((item) =>
