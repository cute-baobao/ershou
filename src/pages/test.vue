...
const coreData = ref([
    {
        ...
        unit: "万吨",
        description: "闲置物品交易",
        detail: "自2015年创建至2020年年末，转转平台已通过促进闲置物品流转累计完成碳减排178.3万吨",
    },
    {
        icon: "mdi:power-plug",
        value: 1320,
        unit: "万吨",
        description: "智能节电设备",
        detail: "国网能源院统计，住宅智能温控/感应照明系统普及率62%，年度节电387亿度，等效减排1320万吨（按0.341kg CO₂/度计算）",
    },
    {
        ...
        unit: "亿吨",
        description: "家庭节水实践",
        detail: "住建部2024白皮书显示，节水型器具覆盖83%城区家庭，年度节水215亿吨，对应水处理碳排减少25.8亿吨（1吨水=120g CO₂）",
    },
]);
