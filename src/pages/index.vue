		...
		<main class="container mx-auto px-[5%] py-6 relative z-10">
			...
			<section class="mb-10 flex flex-wrap -mx-2">
				...
				<div class="w-full md:w-1/2 px-2 mb-4 md:mb-0">
					...
					<div v-if="categoryLoading" class="grid grid-cols-2 gap-3">
						<div
							v-for="i in 4"
							:key="i"
							class="bg-white dark:bg-slate-800 p-3 rounded-lg shadow-md"
						>
					...
					<div v-else class="grid grid-cols-2 gap-3">
						...
						>
							<ShoppingBag
								class="h-10 w-10 mx-auto mb-2 text-green-600 dark:text-green-400"
							/>
							<h3
				...
				<div class="w-full md:w-1/2 px-2">
					<h2
						class="text-2xl font-semibold mb-3 text-gray-800 dark:text-gray-100"
					>
						为什么选择小碳？
					</h2>
					<div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4">
						...
						>
							<component
								:is="reason.icon"
								class="h-8 w-8 text-green-600 dark:text-green-400 mr-3 flex-shrink-0"
							/>
							<div>
								<h3
          ...
          <Skeleton class="w-[50px] h-[50px] rounded-full bg-main" />
				...
				<div class="flex justify-center mt-2">
					<span
						...
						class="text-main cursor-pointer mt-3 text-sm hover:underline flex items-center hover:text-base hover:font-semibold font-bold"
						>查看更多宝贝</span
					>
				</div>
			</section>
...
const reasons = ref([
	{
		title: '环保再利用',
		description: '减少浪费，为地球减轻负担',
		icon: Recycle,
	},
	{
		title: '好礼兑换',
		description: '交易可获得积分，换取精美产品',
		icon: TrendingUp,
	},
